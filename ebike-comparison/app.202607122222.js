(function () {
  ...
  function chatGreeting() {
    ...
    if (bike) {
      return `Hey — I'm ${CHAT_AGENT_NAME}. I can answer questions about the ${productLabel(bike)}, compare it to other rides in our catalog, or explain HB safety rules. What would you like to know?`;
    }
    return `Hey — I'm ${CHAT_AGENT_NAME}. Ask me about e-bikes and scooters in this comparison — safety scores, California rules, battery range, or which models fit a 12-year-old in Huntington Beach.`;
  }
  ...
  function openChatDrawer(prefill) {
    ...
    if (sub) {
      sub.textContent = bike
        ...
        : `${CHAT_AGENT_NAME} · bikes, scooters, safety & HB rules`;
    }
